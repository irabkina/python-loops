...
Report bugs at https://github.com/irabkina/cards/issues.
...
The best way to send feedback is to file an issue at https://github.com/irabkina/cards/issues.
...
3. The pull request should work for Python 2.7, 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.org/irabkina/cards/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_cards
